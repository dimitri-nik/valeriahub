...
export default function InGameAssets() {
  return (
    <div>
      <div className="flex flex-col items-center pt-20 px-10" style={{
        width: "100vw",
        overflow: "hidden",
        ...
        <div className="flex flex-row bg-black border-4 border-white bg-opacity-50 rounded-lg p-6 mt-8 text-sm">
        ...
        <div className="bg-violet-950 border-4 border-white bg-opacity-100 rounded-lg p-5 my-6 text-sm">
